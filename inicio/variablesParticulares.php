...
//session_start();
  ...
  $_SESSION['logo']='../img/logo merce.jpg';//ubicación nombre logo para login
  $_SESSION['logoSE']='../img/logo_se.png';//ubicación nombre logo para login
  $_SESSION['membrete']='../img/membrete_mercedarias.png';//ubicacion nombre membrete para reportes
