...
<head>
    <style>
        ...
        .header img { max-width: 100%; height: 141px; }
        .title { text-align: center; }
        h3, h4 { margin: 2px 0; }
        table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        td { border-bottom: 1px solid #000; padding: 3px 3px; }
        .nombre-personal { width: 40%; }
        .renglon { width: 60%; }
    </style>
</head>
<body>
...
foreach ($personal as $persona) {
    $html .= '
        <tr>
            <td class="nombre-personal" style="border-bottom: 1.5px solid #000; height: 20px;">' . htmlspecialchars($persona['apellido'] . ', ' . $persona['nombre']) . '</td>
...
$dompdf->stream('listado_personal_renglon.pdf', array('Attachment' => 0));
?>
