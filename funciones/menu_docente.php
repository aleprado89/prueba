<?php if (!empty($_SESSION['impersonando'])):
    $lblImpDoc = isset($_SESSION['impersonacion_label']) ? (string) $_SESSION['impersonacion_label'] : 'Usuario';
    ?>
<div class="alert alert-warning text-center m-0 rounded-0 py-2 mb-0 border-0">
  <i class="bi bi-eye-fill"></i>
  Vista desde Secretaría como <strong><?php echo htmlspecialchars($lblImpDoc, ENT_QUOTES, 'UTF-8'); ?></strong>
  &nbsp;·&nbsp;
